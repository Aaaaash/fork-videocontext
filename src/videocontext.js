...
export default class VideoContext {
    ...
    constructor(
        ...
        if ("endOnLastSourceEnd" in options)
            this._endOnLastSourceEnd = options.endOnLastSourceEnd;
        ...
        if (window.__VIDEOCONTEXT_REFS__ === undefined)
         ...
         */
        this._destinationNode = new DestinationNode(
            this._gl,
            this._renderGraph
        );
        ...
        if (
            ...
            */
            ...
            while (nodes.length > 0) {
                ...
                for (let edge of RenderGraph.outputEdgesFor(
                    node,
                    connections
                )) {
                    ...
                    if (
                        RenderGraph.inputEdgesFor(edge.destination, connections)
                            .length === 0
                    ) {
